...
def compile_java():
    ...
    subprocess.run(["javac", "ContractBench.java"], check=True)
...
def main():
    ...
    out_csv = "results_contract_jit_perf.csv"
    out_md = "results_contract_jit_perf.md"
    ...
    graph_dir = os.path.join("graphs", "jit_int")
    out_svg = os.path.join(graph_dir, "contract_jit_speedup_vs_workset.svg")
    ...
    if converter:
        out_png = os.path.join(graph_dir, "contract_jit_speedup_vs_workset.png")

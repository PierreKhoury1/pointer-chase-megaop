...
def compile_java():
    ...
    subprocess.run(["javac", "ContractBenchObj.java"], check=True)
...
def main():
    ...
    out_csv = "results_contract_jit_obj_perf.csv"
    out_md = "results_contract_jit_obj_perf.md"
    ...
    graph_dir = os.path.join("graphs", "jit_obj")
    out_svg = os.path.join(graph_dir, "contract_jit_obj_speedup_vs_workset.svg")
    ...
    if converter:
        out_png = os.path.join(graph_dir, "contract_jit_obj_speedup_vs_workset.png")

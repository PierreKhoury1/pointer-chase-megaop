...
AOT_CSV = AOT_DIR / "data" / "raw" / "results_aot.csv"
HS_CSV = AOT_DIR / "data" / "raw" / "results_hotspot.csv"
OUT_RAW_DIR = AOT_DIR / "data" / "raw"
OUT_PROC_DIR = AOT_DIR / "data" / "processed"
GRAPH_DIR = AOT_DIR / "plots" / "aot_vs_hotspot"
...
def write_combined(aot_rows, hs_rows):
    ...
    out_csv = OUT_RAW_DIR / "combined_aot_hotspot.csv"
    ...
    out_md = OUT_PROC_DIR / "combined_aot_hotspot.md"
...
def plot_combined(aot_rows, hs_rows):
    ...
    for aot_metric, hs_metric, title in METRIC_PAIRS:
        ...
        out_path = GRAPH_DIR / f"aot_vs_hotspot_{aot_metric}.png"
